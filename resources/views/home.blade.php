...
@section('content')
    <div class="container">
        <div class="ongkir-header">
            <h1>Cek Ongkir</h1>
            <p class="leed">
                Cek Ongkir ke Seluruh Kota dan Kabupaten di Indonesia
            </p>
        </div>

        <div class="card-deck card-deck mb-3 text-center">
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-lg btn-block btn-primary">Get startes</button>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="my-0 font-widht-normal">Formulir Cek Ongkir</h4>
            </div>
